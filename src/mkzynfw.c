...
:x
	 ...
	 */
	RTL_OTTO_BOARD("GS1920-24-v1", "Zyxel GS1920-24v1", MID(20994), 16, 0xb0000),	/* AAOB */
	RTL_OTTO_BOARD("GS1920-24HP-v1", "Zyxel GS1920-24HPv1", MID(21250), 16, 0xb0000), /* AAOC */
	RTL_OTTO_BOARD("GS1920-48-v1", "Zyxel GS1920-48v1", MID(20482), 16, 0xb0000),	/* AANZ */
	RTL_OTTO_BOARD("GS1920-48HP-v1", "Zyxel GS1920-48HPv1", MID(20738), 16, 0xb0000), /* AAOA */
